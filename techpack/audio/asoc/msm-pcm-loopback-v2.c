...
static int __init msm_pcm_loopback_init(void)
{
	return platform_driver_register(&msm_pcm_driver);
}
module_init(msm_pcm_loopback_init);

static void __exit msm_pcm_loopback_exit(void)
{
	platform_driver_unregister(&msm_pcm_driver);
}
module_exit(msm_pcm_loopback_exit);
