...
struct panel_incell_ctrl {
	unsigned char state;
	unsigned char backups[INCELL_BACKUP_NUM];

	panel_incell_state_change change_state;
	panel_incell_pw_seq seq;

	bool panel_incell_intf_operation;
	panel_incell_intf_mode intf_mode;

	panel_incell_worker_state worker_state;
...
void panel_driver_detection(struct platform_device *pdev,
...
int panel_driver_reset_panel(struct mdss_panel_data *pdata,
		int enable);
int panel_driver_reset_touch(struct mdss_panel_data *pdata,
		int enable);
...
/* For panel incell driver */
struct panel_incell_ctrl *panel_incell_get_info(void);
void panel_incell_panel_power_worker_canceling(struct panel_incell_ctrl *incell);
void panel_incell_driver_init(void);
